        ...
        <div className="grid md:grid-cols-2 gap-8 mb-32">
          ...
          <Link href="/ochota" className="group relative block overflow-hidden bg-white p-12 rounded-[48px] border border-slate-100 shadow-xl transition-all duration-500 hover:scale-[1.02] z-20 cursor-pointer">
            <div className="relative z-10 space-y-4 pointer-events-none">
              ...
              <p className="text-slate-400 font-medium leading-relaxed font-sans">ul. Pruszkowska 6b<br />Warszawa Ochota</p>
          ...
          <Link href="/ursynow" className="group relative block overflow-hidden bg-[#1A1C1E] p-12 rounded-[48px] shadow-2xl transition-all duration-500 hover:scale-[1.02] z-20 cursor-pointer">
            <div className="relative z-10 space-y-4 pointer-events-none">
              ...
              <p className="text-slate-500 font-medium text-white/60 leading-relaxed font-sans">al. KEN 96<br />Warszawa Ursynów</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl">
            {[
              ...
              <div key={i} className="group p-8 rounded-[40px] bg-white border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500">
                ...
                <p className="text-slate-400 font-medium leading-relaxed text-sm font-sans">{doc.desc}</p>
              </div>
            ))}
          </div>
        </div>
